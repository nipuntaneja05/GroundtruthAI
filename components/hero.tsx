      ...
      <div className="relative z-10">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-light mb-6 md:mb-8">
          ...
          <span className="text-xs md:text-sm font-medium text-slate-300">
            GroundTruth Hackathon · Powered by AI models
          </span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 md:gap-4">
          ...
          <Link 
            href="/docs" 
            className="w-full sm:w-auto px-6 md:px-8 py-3 md:py-4 rounded-full glass-light text-slate-200 font-semibold hover:bg-white/10 transition inline-flex items-center justify-center"
          >
            View Docs
          </Link>
        </div>
