...
Generate 10+ high-quality ad creatives automatically using open-source AI models
...
This project was built for the [Hackathon Name] 2025 – Generative AI & Marketing Tech Track (H-003).
...
LLM (GPT-4o mini / similar open-source LLM) generates matching captions:
...
or any open-source LLM for text
